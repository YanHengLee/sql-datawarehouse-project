...
🎯This repository is to showcase my expertise in:
* SQL Development
* Data Architect
* Data Engineering
...
* **[Datasets](https://github.com/YanHengLee/sql-datawarehouse-project/tree/main/datasets):** Access to the project datasets (csv files).
* **[SQL Server Express](https://www.microsoft.com/en-us/sql-server/sql-server-downloads):** Lightweight server for hosting SQL Databases.
